    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
                <label className="text-slate-700 text-sm font-medium">Website URL</label>
                <div className="flex w-full items-center rounded-lg border border-slate-300 bg-white focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary overflow-hidden transition-all">
                    ...
                    <input
                        ...
                        className="w-full bg-transparent border-none focus:ring-0 text-slate-900 placeholder:text-slate-400 h-11 text-sm outline-none px-2"
            ...
            {/* Contact Number */}
            <div className="flex flex-col gap-2">
                <label className="text-slate-700 text-sm font-medium">Contact Number</label>
                <div className="flex w-full items-center rounded-lg border border-slate-300 bg-white focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary overflow-hidden transition-all">
                    <div className="pl-3 flex items-center justify-center text-slate-400">
            ...
            {/* Products */}
            <div className="flex flex-col gap-2">
                <label className="text-slate-700 text-sm font-medium">Products on Sale</label>
                <div className="flex flex-wrap items-center gap-2 w-full p-2 min-h-[48px] rounded-lg border border-slate-300 bg-white focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary transition-all">
                    {formData.products.map((product, index) => (
                        <div key={index} className="flex items-center gap-1 bg-primary/10 text-primary px-2.5 py-1 rounded-md text-sm font-medium">
                            {product}
                            <button
                                type="button"
                                onClick={() => removeProduct(index)}
                                className="hover:text-blue-700 flex items-center justify-center"
                            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                    <label className="text-slate-700 text-sm font-medium">Campaign Duration</label>
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex justify-between items-center">
                        <label className="text-slate-700 text-sm font-medium">Discount Rate</label>
