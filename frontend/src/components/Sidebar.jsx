...
const Sidebar = ({ mobile, onClick }) => {
    ...
    const sidebarClass = mobile
        ? "flex flex-col h-full bg-surface-light"
        : "w-64 bg-surface-light border-r border-slate-200 flex-shrink-0 flex flex-col justify-between hidden md:flex transition-all duration-300 h-screen sticky top-0";
        ...
        <aside className={sidebarClass}>
            <div className="flex flex-col gap-6 p-6 flex-1 overflow-y-auto">
                <div className="flex items-center gap-3">
                    <div
                        className="relative w-10 h-10 rounded-full bg-cover bg-center shrink-0 border border-slate-200 bg-primary/10 flex items-center justify-center text-primary"
